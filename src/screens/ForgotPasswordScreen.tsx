// /**
//  * Tela ESQUECI A SENHA (duas fases numa tela só):
//  *  1) 'email'  — pede o código: POST /auth/forgot-password (chega no e-mail mock).
//  *  2) 'code'   — redefine: POST /auth/reset-password (email + código + nova senha).
//  *
//  * Ao redefinir, faz login automático com a senha nova (a guarda leva para o app).
//  */
